...
const SocialFeed = () => {
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 pt-6 pb-32 relative z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="glass-card p-1.5 rounded-2xl border border-white/10 flex items-center justify-between shadow-xl">
            {[
              ...
              <button
                key={t.id}
                onClick={() => setTab(t.id)}
                className={`flex-1 py-3 px-2 rounded-xl font-black text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all cursor-pointer ${
                  tab === t.id 
